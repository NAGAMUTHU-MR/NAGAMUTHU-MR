...
<svg width="860" height="320" viewBox="0 0 860 320" xmlns="http://www.w3.org/2000/svg" font-family="'Segoe UI', Arial, sans-serif">
  ...
  <!-- Name -->
  <text x="170" y="72" font-size="22" font-weight="700" fill="#e6edf3">Nagamuthu M R</text>
  <!-- Tagline -->
  ...
  <text x="192" y="126" font-size="13" fill="#c9d1d9">Karur, Tamil Nadu, India</text>
...
|:-------:|:-----:|:------------:|:------:|
| 🌬️ **[VayuRaksha](https://github.com/NAGAMUTHU-MR)** | `IoT` `Embedded Systems` `Hardware` | Wind-adaptive LPG burner safety system | 📜 Group 1 Patent · 💰 ₹5,000 Seed Funding |
| 🗣️ **[Lingua Assist](https://github.com/NAGAMUTHU-MR)** | `Python` `GPT` `NLP` | Multilingual AI assistant with GPT integration | Context-aware · Multi-language support |
| 🚛 **[Movie Recommendation System](https://github.com/NAGAMUTHU-MR)** | `Java` `SQL` `Algorithms` | Movie recommendation using sentiment analysis | SQL-backed · Real-time processing |
| 🛒 **[MineKart](https://github.com/NAGAMUTHU-MR)** | `Kotlin` `Android` `Firebase` | Android shopping app with payment integration | Production-ready UI · In Progress |
...
| 🥈 | **2× NPTEL Silver Certificate** | national-level courses |
...
|:------:|:-----------:|:----:|:-----:|
| 🎓 B.E. — Artificial Intelligence & Machine Learning | M. Kumarasamy College of Engineering, Karur | 2023 – 2027 | CGPA: **7.6** |
| 📚 Higher Secondary Certificate (HSC) | Cheran Matriculation Higher Secondary School, Karur | 2022 – 2023 | **86%** |
| 📖 Secondary School Leaving Certificate (SSLC) | Cheran Matriculation Higher Secondary School, Karur | 2020 – 2021 | **80%** |
